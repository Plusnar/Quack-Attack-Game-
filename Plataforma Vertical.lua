...
local platform = game.Workspace:WaitForChild("door") -- Ensure the platform exists in Workspace
...
local buttonPart = game.Workspace:WaitForChild("Button3") -- Ensure Button3 exists in Workspace
